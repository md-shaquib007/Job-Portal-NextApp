    ...
    <div className="max-w-md w-full space-y-6 bg-white p-8 rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 mx-4">
      ...
      {githubEnabled ? (
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 font-semibold cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
        >
        ...
        <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg text-center">
          <p className="text-xs text-gray-500">
            💡 <strong className="font-semibold text-gray-700">GitHub OAuth 2.0 Setup</strong>: Set <code className="bg-gray-100 px-1 py-0.5 rounded">GITHUB_CLIENT_ID</code> & <code className="bg-gray-100 px-1 py-0.5 rounded">GITHUB_CLIENT_SECRET</code> in Vercel settings to enable OAuth login.
          </p>
        </div>
      )}
